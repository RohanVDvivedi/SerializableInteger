...
#define declarations_large_uint(large_uint, LARGE_UINT_LIMBS_COUNT)                                                                                         \
	...
	static inline uint32_t get_max_bytes_ ## large_uint();                                                                                                  \
                                                                                                                                                            \
	/* number of bits of data in a large_uint */                                                                                                            \
	static inline uint32_t get_bit_width_ ## large_uint();                                                                                                  \
                                                                                                                                                            \
	/* get a default uint64_t val valued large_uint */                                                                                                      \
	static inline large_uint get_ ## large_uint(uint64_t val);                                                                                              \
                                                                                                                                                            \
	/* get zero and one values for a large_uint */                                                                                                          \
	static inline large_uint get_0_ ## large_uint();                                                                                                        \
	static inline large_uint get_1_ ## large_uint();                                                                                                        \
                                                                                                                                                            \
	/* get min and max values for a large_uint */                                                                                                           \
	static inline large_uint get_min_ ## large_uint();                                                                                                      \
	static inline large_uint get_max_ ## large_uint();                                                                                                      \
                                                                                                                                                            \
	/* gets a bit from large_uint */                                                                                                                        \
	static inline int get_bit_from_ ## large_uint(large_uint a, uint32_t bit_index);                                                                        \
                                                                                                                                                            \
	/* set a bit in large_uint */                                                                                                                           \
	static inline int set_bit_in_ ## large_uint(large_uint* res, uint32_t bit_index);                                                                       \
                                                                                                                                                            \
	/* reset a bit in large_uint */                                                                                                                         \
	static inline int reset_bit_in_ ## large_uint(large_uint* res, uint32_t bit_index);                                                                     \
                                                                                                                                                            \
	/* gets a byte from large_uint */                                                                                                                       \
	static inline uint8_t get_byte_from_ ## large_uint(large_uint a, uint32_t byte_index);                                                                  \
                                                                                                                                                            \
	...
	static inline large_uint bitwise_not_ ## large_uint(large_uint a);                                                                                      \
                                                                                                                                                            \
	/* returns a & b */                                                                                                                                     \
	static inline large_uint bitwise_and_ ## large_uint(large_uint a, large_uint b);                                                                        \
                                                                                                                                                            \
	/* returns a | b */                                                                                                                                     \
	static inline large_uint bitwise_or_ ## large_uint(large_uint a, large_uint b);                                                                         \
                                                                                                                                                            \
	/* returns a ^ b */                                                                                                                                     \
	static inline large_uint bitwise_xor_ ## large_uint(large_uint a, large_uint b);                                                                        \
                                                                                                                                                            \
	/* returns a << s */                                                                                                                                    \
	static inline large_uint left_shift_ ## large_uint(large_uint a, uint32_t s);                                                                           \
                                                                                                                                                            \
	/* returns a >> s */                                                                                                                                    \
	static inline large_uint right_shift_ ## large_uint(large_uint a, uint32_t s);                                                                          \
                                                                                                                                                            \
	/* if(a < b) returns -1 */                                                                                                                              \
	...
	static inline int are_equal_ ## large_uint(large_uint a, large_uint b);                                                                                 \
                                                                                                                                                            \
	/* returns a == 0 */                                                                                                                                    \
	static inline int is_zero_ ## large_uint(large_uint a);                                                                                                 \
                                                                                                                                                            \
	/* calculate min of 2 values */                                                                                                                         \
	static inline large_uint min_ ## large_uint(large_uint a, large_uint b);                                                                                \
                                                                                                                                                            \
	/* calculate min of 2 values */                                                                                                                         \
	static inline large_uint max_ ## large_uint(large_uint a, large_uint b);                                                                                \
                                                                                                                                                            \
	/* (*res) = a + b + carry and then returns carry */                                                                                                     \
	static inline uint64_t add_with_carry_ ## large_uint(large_uint* res, large_uint a, large_uint b, uint64_t carry_in);                                   \
                                                                                                                                                            \
	/* returns carry after performing (*res) = a + b; */                                                                                                    \
	static inline uint64_t add_ ## large_uint(large_uint* res, large_uint a, large_uint b);                                                                 \
                                                                                                                                                            \
	/* returns carry after performing (*res) = a - b; */                                                                                                    \
	static inline uint64_t sub_ ## large_uint(large_uint* res, large_uint a, large_uint b);                                                                 \
                                                                                                                                                            \
	/* returns a number with only lowset significant n bits set */                                                                                          \
	/* this function can be used to build bit masks */                                                                                                      \
	/* returns ((1 << n) - 1) */                                                                                                                            \
	static inline large_uint get_bitmask_lower_n_bits_set_ ## large_uint(uint32_t n);                                                                       \
                                                                                                                                                            \
	...
	static inline int add_overflow_safe_ ## large_uint(large_uint* res, large_uint a, large_uint b, large_uint max_limit);                                  \
                                                                                                                                                            \
	/* res will be set with subtraction, on success (i.e. return 1) */                                                                                      \
	/* failure happens in case of an underflow, when (a < b) */                                                                                             \
	static inline int sub_underflow_safe_ ## large_uint(large_uint* res, large_uint a, large_uint b);                                                       \
                                                                                                                                                            \
	...
	static inline large_uint mul_ ## large_uint(large_uint* res, large_uint a, large_uint b);                                                               \
                                                                                                                                                            \
	...
	static inline large_uint div_ ## large_uint(large_uint* quotient, large_uint dividend, large_uint divisor);                                             \
                                                                                                                                                            \
	/* find gcd of two numbers */                                                                                                                           \
    static inline large_uint gcd_ ## large_uint(large_uint a, large_uint b);                                                                                \
                                                                                                                                                            \
	...
	static inline int cast_to_uint64_from_ ## large_uint(uint64_t* value, large_uint a);                                                                    \
                                                                                                                                                            \
	/* serialize and deserialize large_uint-s */                                                                                                            \
	static inline void serialize_ ## large_uint(void* bytes, uint32_t bytes_size, large_uint l);                                                            \
	static inline large_uint deserialize_ ## large_uint(const char* bytes, uint32_t bytes_size);                                                            \
                                                                                                                                                            \
	/* print large_uint */                                                                                                                                  \
	static inline void print_ ## large_uint(large_uint l);                                                                                                  \
	/* print large_uint */                                                                                                                                  \
