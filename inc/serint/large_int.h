...
#define definitions_large_int(large_int, large_uint)                                                                                                        \
	...
	{                                                                                                                                                       \
		...
		if(msb)                                                                                                                                             \
			a =  bitwise_or_ ## large_int(a, bitwise_not_ ## large_int(get_bitmask_lower_n_bits_set_ ## large_int(get_bit_width_ ## large_int() - s)));     \
		return a;                                                                                                                                           \
	}                                                                                                                                                       \
                                                                                                                                                            \
	static inline int compare_ ## large_int(large_int a, large_int b)                                                                                       \
	...
	{                                                                                                                                                       \
		...
		if(sign_bit_a != sign_bit_b)                                                                                                                        \
		{                                                                                                                                                   \
			uint64_t carry = add_ ## large_uint(&(res->raw_uint_value), bitwise_not_ ## large_uint(res->raw_uint_value), get_1_ ## large_uint());           \
			add_ ## large_uint(&(high.raw_uint_value), bitwise_not_ ## large_uint(high.raw_uint_value), get_ ## large_uint(carry + 1));                     \
        }                                                                                                                                                   \
                                                                                                                                                            \
		return high;                                                                                                                                        \
	}                                                                                                                                                       \
